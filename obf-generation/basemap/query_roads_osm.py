...
if __name__ == "__main__":
	process_roads("highway='primary' or highway='primary_link' or highway='motorway' or highway='motorway_link' or highway='tunk' or highway='trunk_link'", "line_motor_trunk_primary.osm", ['highway', 'junction', 'route'])
