...
public interface DeviceSubscriptionsRepository extends JpaRepository<SupporterDeviceSubscription, SupporterDeviceSubscriptionPrimaryKey> {
	...
	List<SupporterDeviceSubscription> findByOrderIdAndPurchaseTokenAndSku(String orderId, String purchaseToken, String sku);
    ...
    List<SupporterDeviceSubscription> findAllBySupporterId(Long supporterId);
