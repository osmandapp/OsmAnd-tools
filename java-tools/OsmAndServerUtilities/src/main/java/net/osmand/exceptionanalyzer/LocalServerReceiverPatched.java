 ...
 * @author Yaniv Inbar
 */
public final class LocalServerReceiverPatched implements VerificationCodeReceiver {
   ...
   */
  public LocalServerReceiverPatched(String host, int port, String proxyCallbackUrl) {
    this.host = host;
    this.port = port;
  ...
  public static final class Builder {
    ...
    /** Builds the {@link LocalServerReceiverPatched}. */
    public LocalServerReceiverPatched build() {
      return new LocalServerReceiverPatched(host, port, null);
    }
