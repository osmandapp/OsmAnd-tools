...
public class SvgMapLegendGenerator {
    ...
    static String resultIconsFolderPath = webRepoPath + "/main/static/img/legend/osmand/";
    static String resultComponentsPath = webRepoPath + "/main/src/components/docs/autogenerated/";
