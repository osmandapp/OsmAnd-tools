...
public class SvgMapLegendGenerator {
    ...
    static String configPath = System.getProperty("user.dir") + "/OsmAndMapCreatorUtilities/src/main/java/net/osmand/maplegend/config.xml";
    static String resultIconsFolderPath = System.getenv("web.repo.dir") + "/main/static/img/legend/osmand/";
    static String resultComponentsPath = System.getenv("web.repo.dir") + "/main/src/components/docs/autogenerated/";

    static String shieldsFolder = System.getenv("resources.repo.dir") + "/icons/svg/shields/";
    static String iconsFolder = System.getenv("resources.repo.dir") + "/rendering_styles/style-icons/poi-icons-svg/";
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            ...
            if (Algorithms.isEmpty(System.getenv("web.repo.dir")) || Algorithms.isEmpty(System.getenv("resources.repo.dir"))) {
                throw new Exception("ERROR: SvgMapLegendGenerator - empty env parameters 'web.repo.dir' and 'resources.repo.dir' ");
            }
            ...
            for (GroupDTO group : configGroups) {
                for (IconDTO icon : group.icons) {
                    String[] argumentsDay = {rendererName, icon.tag, icon.value, icon.tag2, icon.value2, "false", Integer.toString(icon.zoom), System.getenv("resources.repo.dir")};
                    String[] argumentsNight = {rendererName, icon.tag, icon.value, icon.tag2, icon.value2, "true", Integer.toString(icon.zoom), System.getenv("resources.repo.dir")};
    ...
    private static class ReactComponentsGenerator {
        public static void generate(ArrayList<GroupDTO> groups) throws Exception {
            for (GroupDTO group : groups) {
                ...
                String path = resultComponentsPath +  "LegendItemAutogenerated" + CapitalisedName + ".js";
                try {
                    FileWriter writer = new FileWriter(path);
                    writer.write(content);
                    writer.close();
